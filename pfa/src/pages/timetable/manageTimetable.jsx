...
// console.log(timetable)
    ...
    useEffect(() => {
      const fetchData = async () => {
        try {
          const response = await axios.get("http://localhost:3001/personnels/"+teacher);
          ...
          if (re.data.length===0){
            ...
            {enqueueSnackbar('Timetable Created !')}
    ...
    const columns = [
      ...
      const putData=()=>{
        {enqueueSnackbar('Timetable Modified !')}
        console.log(array)
        axios.put('http://localhost:3001/timetables/update/'+timetable._id,array)
              .then( response => {
                
                console.log(timetable.Personnel)
                axios.get("http://localhost:3001/timetables/get/"+timetable.Personnel)
            .then(response => {
              setArray({})
            })
  ...
  return (
    <div>
      ...
      <div className="users">
        {open && <Add slug="Timetable" columns={columns} setOpen={setOpen} classrooms={classrooms}classes={classes} setArray={setArray} array={array} putData={putData}/>}
        </div>
      <div className='current'>
        <div><div className='titleOP'>Timetables</div>
        <div>
      <SnackbarProvider />
